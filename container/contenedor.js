        ...
        try {
            if (this.exists(this.archivo)) {
                ...
                if (data.length !== 0) {
                    ...
                    throw new Error(`El archivo ${this.archivo} esta vacío`);
                }
            }
        } catch (error) {
